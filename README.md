...
2. 압축 해제
3. `JasoHapChe.app`을 `/Applications` 폴더로 이동
4. 실행 (처음 실행 시 "확인되지 않은 개발자" 경고가 뜨면: 시스템 설정 > 개인정보 보호 및 보안 > "확인 없이 열기")
...
2. Unzip
3. Move `JasoHapChe.app` to `/Applications`
4. Run (if you see "unidentified developer" warning: System Settings > Privacy & Security > "Open Anyway")
